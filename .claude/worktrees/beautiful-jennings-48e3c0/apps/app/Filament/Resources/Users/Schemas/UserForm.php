                                    ...
                                    Grid::make(1)
                                        ->schema([
                                            PhoneInput::make('phone')
                                                ...
                                                ->hint(fn(Get $get) => (bool) $get('has_whatsapp') ? 'WhatsApp' : null)
                                                ->hintIcon(
                                                    fn(Get $get,
                                                    ) => (bool) $get('has_whatsapp') ? 'heroicon-m-check-badge' : 'tabler-brand-whatsapp',
                                                    tooltip: 'Include country code (e.g., +1 for USA). If the phone number has WhatsApp it will turn green',
                                                )
                                                ->hintColor(fn(Get $get,
                                                ) => (bool) $get('has_whatsapp') ? 'success' : 'gray'),
