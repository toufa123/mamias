    ...
    <div class="me-0.5 flex items-center gap-2">
        ...
        @if (Route::has('filament.mamias.auth.login'))
            @auth
                ...
                >
                    <button class="relative size-9 overflow-visible" data-kt-dropdown-toggle="true">
                    ...
                    <div class="kt-dropdown-menu w-[265px]" data-kt-dropdown-menu="true">
                        <div class="flex items-center justify-between gap-1.5 px-2.5 py-1.5">
                            <div class="flex items-center gap-2">
                                <div class="kt-avatar relative size-14 overflow-visible rounded-full">
                        ...
                        <ul class="kt-dropdown-menu-sub">
                            @if (auth()->user()->hasAnyRole(['super_admin', 'admin', 'scientist']))
                                ...
                                <a class="kt-dropdown-menu-link" href="{{ route('filament.mamias.pages.dashboard') }}">
                            ...
                            <li>
                                <a class="kt-dropdown-menu-link" href="{{ route('my-species-reports') }}">
                            ...
                            <li>
                                <a class="kt-dropdown-menu-link" href="{{ route ('suggestions') }}">
                        ...
                        <div class="mb-2.5 flex flex-col gap-3.5 px-2.5 pt-1.5">
                            ...
                            <form action="{{ route('filament.mamias.auth.logout') }}" method="POST" id="logout-form">
                                @csrf
            ...
            @else
                ...
                @if (Route::has('filament.mamias.auth.register'))
                    <div class="border-border h-5 border-e"></div>
