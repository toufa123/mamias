<div class="fiwa-step-import">
    ...
    @elseif(in_array($status, ['completed', 'completed_with_errors']))
        <div class="fiwa-completed">
            @if($status === 'completed_with_errors')
                <div class="fiwa-completed-icon" style="color: var(--color-warning-500);">
            ...
            <div style="margin-top: 20px;">
                <button type="button" wire:click="closeModal" class="fiwa-btn-primary">
                    Close
                </button>
            </div>
        </div>
