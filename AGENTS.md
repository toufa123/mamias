...
- Test environment uses a dedicated PostgreSQL/PostGIS database, `mamias_test` (`apps/phpunit.xml`) — not SQLite, since the schema uses PostGIS types SQLite can't express.
